...
<html lang="en">
  <head>
    ...
    <script
      type="module"
      src="local for cfla or our cdn/page-title.min.js"></script>
    <link
      rel="stylesheet"
      href="https://demo.turn.lv/cfla_dist/themes.css" />
    <link
      rel="stylesheet"
        ...
        <cds-table-row>
          ...
          <cds-table-cell>
            <cds-overflow-menu>
              ...
              <span slot="tooltip-content">Darbības ar  1.1.1.1/16/A projektu</span>
