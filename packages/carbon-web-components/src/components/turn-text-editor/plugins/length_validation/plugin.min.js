tinymce.PluginManager.add('background_color_change', function(editor) {
    ...
    function insertCustomHtml() {
        ...
        editorElement.insertAdjacentHTML('beforebegin', customHtml);
    }
    ...
    editor.on('blur', function() {
        if(!editor.isNotDirty){
            makePostRequest(fetchObject, { content: editor.getContent({ format: 'html' }) });
        }
    });
});