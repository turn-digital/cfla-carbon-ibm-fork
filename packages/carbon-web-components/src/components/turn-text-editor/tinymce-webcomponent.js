(function () {
  ...
  const lookup = (values) => (key) =>
    isLookupKey(values, key) ? values[key] : key;
  ...
  const parseNumberOrString = (value) =>
  ...
  class TinyMceEditor extends HTMLElement {
    ...
    static get observedAttributes() {
      ...
      return ['form', 'readonly', 'autofocus', 'placeholder']
        .concat(nativeEvents)
        .concat(tinyEvents);
    }
    constructor() {
      ...
      this._eventAttrHandler = (records) => {
        records.forEach((record) => {
          ...
          if (
            ...
            record.target === this &&
            ((_a = record.attributeName) === null || _a === void 0
              ? void 0
              : _a.toLowerCase().startsWith('on-'))
          ) {
            this._updateEventAttr(
    ...
    _updateForm() {
      if (this.isConnected) {
        ...
        const form =
          formId !== null
            ? this.ownerDocument.querySelector('form#' + formId)
            : closestRecursive('form', this);
        if (this._form !== form) {
          if (this._form !== null) {
    ...
    _getConfig() {
      ...
      const config =
        (_b = parseGlobal(
          (_a = this.getAttribute('config')) !== null && _a !== void 0 ? _a : ''
        )) !== null && _b !== void 0
          ? _b
          : {};
      for (let i = 0; i < this.attributes.length; i++) {
        ...
        if (attr !== null) {
          if (has(configAttributes, attr.name)) {
            const prop = has(configRenames, attr.name)
              ? configRenames[attr.name]
              : attr.name;
    ...
    _doInit() {
      ...
      target.value =
        (_a = this.textContent) !== null && _a !== void 0 ? _a : '';
      const attrId =
        (_b = this.attributes.getNamedItem('id')) === null || _b === void 0
          ? void 0
          : _b.value;
      if (attrId) {
        target.id = attrId;
    ...
    _loadTinyDoInit() {
      if (this._getTinymce()) {
        ...
        ScriptLoader.load(this.ownerDocument, this._getTinymceSrc(), () =>
          this._doInit()
        );
      }
    }
