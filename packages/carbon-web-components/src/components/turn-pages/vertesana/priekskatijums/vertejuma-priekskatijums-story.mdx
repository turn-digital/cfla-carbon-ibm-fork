...
<head>
    ...
    <script type="module" src="http://localhost:8001/turn-main-content-block.min.js"></script>
    <script type="module" src="https://demo.turn.lv/cfla_dist/turn-back-to.min.js"></script>
    <script type="module" src="http://localhost:8001/turn-label-value.min.js"></script>
