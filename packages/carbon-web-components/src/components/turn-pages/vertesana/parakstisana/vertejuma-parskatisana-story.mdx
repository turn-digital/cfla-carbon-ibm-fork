...
<html lang="en">
  <head>
    ...
    <script
      type="module"
      src="https://1.www.s81c.com/common/carbon/web-components/tag/v2/latest/link.min.js"></script>
    <script
      type="module"
    ...
    <script
      type="module"
      src="https://1.www.s81c.com/common/carbon/web-components/tag/v2/latest/radio-button.min.js"></script>
    <script
      type="module"
