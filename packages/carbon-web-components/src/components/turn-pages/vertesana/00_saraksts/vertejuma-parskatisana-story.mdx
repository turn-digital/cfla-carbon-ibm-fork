...
<body class="cds-theme-zone-white">
    <cds-main-content-block>
        <cds-header-project-block class="cds--css-grid-column cds--col-span-100"
            ...
            <cds-table expandable size="xs">
                ...
                <cds-table-body>
                    ...
                    <cds-table-expanded-row>
                        <cds-label-value label="PI nosaukums" value="Pētniecības pakalpojumi"></cds-label-value>
                        <cds-label-value label="Iesniedzējs" value="Latvijas Universitāte"></cds-label-value>
