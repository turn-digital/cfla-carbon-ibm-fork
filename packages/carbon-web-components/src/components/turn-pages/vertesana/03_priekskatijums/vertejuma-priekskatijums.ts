...
import styles from './vertejuma-priekskatijums.scss';
...
@customElement(`${prefix}-page-priekskatijums`)
  ...
  render() {
    ...
    <link
        ...
        <cds-main-content-item size="08"
          ...
          <cds-main-content-item size="05" class="cds--css-grid-column cds--sm:col-span-4 cds--md:col-span-8 cds--lg:col-span-10 cds--lg:col-span-10">
