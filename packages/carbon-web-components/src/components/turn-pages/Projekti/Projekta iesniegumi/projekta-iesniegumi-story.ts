...
import storyDocs from './projekta-iesniegumi-story.mdx';
import './projekta-iesniegumi';
    ...
    <div class="cds-theme-zone-white cds-page-main-content">
      <div class="cds--css-grid cds--css-grid--narrow">
        <div
          ...
          <cds-page-title
            title="Projektu iesniegumi"
            subtitle="Atlases, kurās gatavojat pieteikumu, bet vēl nav noslēgts līgums">
          </cds-page-title>
...
export default {
  ...
  title: 'Views/Projekti/Projekta iesniegumi',
};
