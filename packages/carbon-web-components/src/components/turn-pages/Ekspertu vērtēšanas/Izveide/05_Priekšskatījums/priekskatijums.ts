...
@customElement(`${prefix}-ekspertu-priekskatijums`)
class CDSPVertesanasEkspertuPriekskatijums extends LitElement {
  render() {
...
export default CDSPVertesanasEkspertuPriekskatijums;
