...
<html lang="en">
  <head>
    ...
    <script
      type="module"
      src="https://demo.turn.lv/cfla_dist/turn-tab-content-container.min.js"></script>
    <script
      type="module"
    ...
    <cds-main-content-block-open withTabs>
          ...
          <div
            ...
            <div>
              ...
              <cds-main-content-item size="01" isStatusChangePanel>
                <cds-countdown-timer
                  deadline="2024-12-16T00:00:00"></cds-countdown-timer>
              </cds-main-content-item>
            </div>
          </div>
        </div>
      ...
      <div slot="tabs" class="cds--css-grid-column cds--col-span-100">
        <cds-tabs
          ...
          <cds-tab id="tab-2" target="panel-2" value="tab-2" disabled
            >Projekts</cds-tab
          >
        </cds-tabs>
