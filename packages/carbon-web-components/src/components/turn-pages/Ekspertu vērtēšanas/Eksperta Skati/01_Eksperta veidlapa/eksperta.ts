      ...
      <cds-main-content-block-open>
          ...
          <div class="cds--css-grid cds--css-grid--narrow">
            <div
              ...
              <cds-main-content-item size="07">
                <cds-header-title
                  title="Eksperta vērtēšanas veidlapa" subtitle="LZP eksperts"></cds-header-title>
        ...
        <cds-main-content-item
          ...
          <cds-table-header-title slot="title"
            >Vērtējamie dokumenti</cds-table-header-title
          >
          <cds-table-head>
        ...
        <cds-empty-state text="Šobrīd vērtējums nav pievienots" link="#" linkText="Pievienot"></cds-empty-state>
        </div>
      </cds-main-content-block-open>
...
"savedAlertMessages": "All data saved successfully"
      ...
      <cds-modal id="status-change-modal">
        ...
        <cds-modal-body>
          ...
          <cds-width-container width="180px">
            <cds-dropdown title-text="Nodaļas vadītājs" value="foo">
              <cds-dropdown-item value="foo">Anna Bērza 1</cds-dropdown-item>
              <cds-dropdown-item value="bar">Anna Bērza 2</cds-dropdown-item>
              <cds-dropdown-item value="baz">Anna Bērza 3</cds-dropdown-item>
            </cds-dropdown>
          </cds-width-container>
        ...
        textEditorData="Projekta iesniegums iesniegts Kohēzijas politikas fondu vadības informācijas sistēmā 2014.-2020.gadam (turpmāk – KPVIS). "
        ></cds-text-editor>
        </cds-modal-body>
        <cds-modal-footer>
          <cds-modal-footer-button kind="secondary" data-modal-close
