...
import { LINK_SIZE } from './link-with-icons';
import storyDocs from './link-with-icons-story.mdx';
...
export const Default = () => {
  return html` <cds-link-with-icons href="#"> Link with icons </cds-link-with-icons> `;
};
...
export const Inline = () => {
  return html`
    <cds-link-with-icons inline href="#"
      >Lorem ipsum dolor sit amet, consectetur adipiscing elit.</cds-link-with-icons
    >
    <p>
      ...
      <cds-link-with-icons inline href="#"
        >Maecenas nunc mauris, consequat quis mauris sit amet,</cds-link-with-icons
      >
...
export default {
  title: 'Custom-components/Link-with-icons',
  parameters: {
    ...storyDocs.parameters,
  },
};
