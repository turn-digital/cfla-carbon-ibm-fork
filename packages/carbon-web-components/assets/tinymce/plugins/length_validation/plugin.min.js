tinymce.PluginManager.add('length_validation', function(editor) {
    ...
    var errorMsgValiodatsSEasdsa = window['config_' + editor.id].fetch_obj || '';
    ...
    function insertCustomHtml() {
        ...
        var textLengthValidationErrorMsgHtml = `<div id="error-div" style="color: red"><p>Pārsniegts maksimālais zīmju skaits, nodzēsiet pārsniegto tekstu</p></div>`;
        ...
        textLengthValidationErrorMsgElement.insertAdjacentHTML('afterend', textLengthValidationErrorMsgHtml);
    }
    ...
    function lengthValidation() {
        ...
        var customHtmlElement = editor.getElement().parentNode.querySelector(`#${customElementId}`);
    ...
    editor.on('blur', function() {
        if(!editor.isNotDirty){
            makePostRequest(fetchObject, { text: editor.getContent({ format: 'text' }) });
        }
    });
});