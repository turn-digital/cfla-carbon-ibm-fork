tinymce.PluginManager.add('length_validation', function (editor) {
  var maxCharLength = window['config_' + editor.id].max_char_length || '';
  var editorTitle = window['config_' + editor.id].editorTitle || '';
  var onServerErrorText = window['config_' + editor.id].onServerErrorText || '';
  var length_validation_error_text =
    window['config_' + editor.id].length_validation_error_text ||
    'Pārsniegts maksimālais zīmju skaits, nodzēsiet pārsniegto tekstu';

  if (onServerErrorText) {
    editor.notificationManager.open({
      text: onServerErrorText,
      type: 'error',
    });
  }
