tinymce.PluginManager.add('length_validation', function (editor) {
  ...
  const editorChars = editor.PluginManager.get('wordcount').getCount();
  const editorChars1 = editor.PluginManager.get('wordcount');

  console.log('editorChars', editorChars);
  console.log('editorChars1', editorChars1);
