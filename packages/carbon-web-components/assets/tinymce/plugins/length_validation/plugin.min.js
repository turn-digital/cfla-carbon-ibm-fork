  ...
  function makePostRequest(fetchObject, data) {
    ...
    fetch(fetchObject.urlToFetch, {
      ...
      headers: {
        ...
        // prettier-ignore
        "__RequestVerificationToken": `${fetchObject.verificationToken}`,
      },
      ...
      .catch((error) => {
        ...
        editor.notificationManager.open({
          text: fetchObject.errorAlertMessage || 'An error occurred.',
          type: 'error',
        });
      });
  }
    ...
    if (!editor.isNotDirty) {
      if (isModal) {
        ...
        makePostRequest(fetchObject, {
          [fetchObject.requestValueKey]: editor.getContent({ format: 'html' }),
        });
      }
    }
  });
