  ...
  function insertServerInfoHtml() {
    ...
    var serverInfoHtml = `
      ...
      onServerLastEditor?.date || ''
            ...
            ${
              requestObject
                ? `<div style="display: flex;"><p id="server-saved-text-${editorId}" style="display: none; color: #5F6367; font-size: 12px; font-weight: 400; margin-right: 10px;"></p><cds-button id="save-button-${editorId}" size="sm" style="margin-top: 2px;">Saglabāt</cds-button></div>`
                : ''
            }
        </div>
    `;
